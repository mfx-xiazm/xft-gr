...
@interface RCRoleProtocolVC ()<WKNavigationDelegate,WKUIDelegate>
@property (nonatomic, strong) WKWebView     *webView;
@property (weak, nonatomic) IBOutlet UIView *webSuperView;

@end

@implementation RCRoleProtocolVC
...
-(void)viewDidLayoutSubviews
{
    ...
    self.webView.frame = self.webSuperView.bounds;
}
- (IBAction)uoRoleClicked:(UIButton *)sender {
...
- (WKWebView *)webView{
    if (_webView == nil) {
        ...
        _webView = [[WKWebView alloc] initWithFrame:self.webSuperView.bounds configuration:configuration];
        ...
        _webView.scrollView.contentInset = UIEdgeInsetsMake(0, 0, 60.f, 0);
    }
