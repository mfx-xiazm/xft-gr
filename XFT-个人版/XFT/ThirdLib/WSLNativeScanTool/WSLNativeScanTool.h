 ...
 */
- (instancetype _Nonnull )initWithPreview:(UIView *_Nullable)preview andScanFrame:(CGRect)scanFrame;
...
/**
 ...
 @return image二维码
 */
+ (UIImage *_Nonnull)createQRCodeImageWithString:(nonnull NSString *)codeString andSize:(CGSize)size andBackColor:(nullable UIColor *)backColor andFrontColor:(nullable UIColor *)frontColor andCenterImage:(nullable UIImage *)centerImage;
